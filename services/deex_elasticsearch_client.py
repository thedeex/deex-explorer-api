...
class DeexElasticSearchClient():
    ...
    def get_markets(self, from_date, to_date, base=None, quote=None):
        ...
        response = client.search(index="deex-*", body=query)
...
client = DeexElasticSearchClient(config.ELASTICSEARCH, config.ELASTICSEARCH_ADDITIONAL)
